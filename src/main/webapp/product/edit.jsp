...
<form method="post">
    <fieldset>
        ...
        <table>
            <tr>
                <td>Product name: </td>
                <td><input type="text" name="prodname" id="prodname" value="${requestScope["product"].getProdname()}"></td>
            </tr>
            <tr>
                <td>Price: </td>
            ...
            <tr>
                <td>Brand: </td>
                <td><input type="text" name="vendorx" id="vendorx" value="${requestScope["product"].getVendorx()}"></td>
            </tr>
            <tr>
                <td></td>
